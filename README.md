# Batalha Naval - Implementação em Python
...
- Estruturas de Dados: Utilização de listas multidimensionais para representação do tabuleiro.
- Algoritmos: Implementação de lógica de verificação de limites e detecção de colisões de projéteis.

## Objetivos Acadêmicos
O desenvolvimento deste software permitiu a consolidação de conceitos fundamentais como estruturas de repetição aninhadas, condicionais complexas e tratamento de entradas de dados.
